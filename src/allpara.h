      ...
      real*8 kxmin,kzmin,Ra,Kscalar,Pr,Rt,Rs,Le,Omegay,Omegaz,lapse
     ...
     +   Rt,Rs,Le,Omegay,Omegaz,lapse

      namelist /numeric/ptan,qtan,dt,ttot,nsave,alfa,beta,gamma,zeta
      namelist /phys/Lx,Lz,DD,Ra,Re,Pr,Kscalar,Rt,Rs,Le,Omegay,Omegaz,lapse
